...
export default function NewsCard({ category, title, readTime }: NewsCardProps) {
  return (
    <motion.article
      whileHover={{ y: -4 }}
      transition={{ duration: 0.2, ease: "easeOut" }}
      className="group relative flex flex-col justify-between rounded-xl border border-dark-border bg-dark-card p-6 transition-colors hover:border-brand-crimson/50"
    >
      <div>
